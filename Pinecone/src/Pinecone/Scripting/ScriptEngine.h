...
namespace Pinecone
{
	...
	public:
		...
		static Ref<ScriptInstance> GetGameObjectScriptInstance(UUID gameObjectID);

		static Ref<ScriptClass> GetGameObjectClass(const std::string& name);
		static std::unordered_map<std::string, Ref<ScriptClass>> GetGameObjectClasses();
		static ScriptFieldMap& GetScriptFieldMap(GameObject gameObject);
	...
	namespace Utils {
		...
		inline const char* ScriptFieldTypeToString(ScriptFieldType fieldType)
		{
			...
			PC_CORE_ASSERT(false, "Unknown ScriptFieldType");
			return "None";
		}
